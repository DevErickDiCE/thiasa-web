                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 mb-12">
                    ...
                    <div className="flex flex-col items-center md:items-start order-2 space-y-4">
                        ...
                        <ul className="space-y-3 text-center md:text-left">
                            ...
                            <li><Link href="/servicios/reformas-locales-comerciales" className="text-white/70 hover:text-accent transition-colors text-sm">Locales Comerciales</Link></li>
                            <li><Link href="/proyectos" className="text-white/70 hover:text-accent transition-colors text-sm">Proyectos realizados</Link></li>
                    ...
                    <div className="text-center">
                        <p className="text-white/40 text-xs">
                            ...
                            <a
                                ...
                                className="text-accent hover:text-sky-400 transition-colors font-medium"
                            >
                                PotencIA Soluciones
                            </a>
                        </p>
