                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {services.map((service, index) => (
                        <div
                            key={index}
                            data-reveal
                            style={{ "--reveal-delay": Math.min(index, 5) } as React.CSSProperties}
                            className="group relative bg-gradient-to-br from-white/5 to-white/[0.02] border border-white/10 rounded-2xl overflow-hidden hover:border-accent/30 transition-all duration-300 hover:shadow-2xl hover:shadow-black/40 hover:-translate-y-1 backdrop-blur-sm">
                            <div className={`h-1 bg-gradient-to-r ${service.gradient}`} />
                            <div className="p-8">
                                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-accent/10 to-primary/10 border border-accent/20 flex items-center justify-center mb-6 group-hover:border-accent/40 transition-all duration-300">
                    ...
                    <div
                        ...
                        className="bg-gradient-to-br from-primary to-[#003580] rounded-2xl p-8 flex flex-col justify-center items-start text-white shadow-2xl shadow-black/40 border border-white/10 relative overflow-hidden group">
