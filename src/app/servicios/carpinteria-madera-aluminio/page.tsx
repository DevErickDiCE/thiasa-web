        ...
        <main>
            <section className="relative bg-[#1D1D1D] min-h-[500px] flex items-center pt-32 pb-20 overflow-hidden">
                <div className="absolute inset-0">
                    <Image src="/project-living-1.jpg" alt="Carpintería de madera y aluminio Madrid - THIASA" fill className="object-cover opacity-30" />
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                    ...
                    <div className="max-w-3xl">
                        ...
                        <p className="text-xl text-white/80 mb-8 leading-relaxed">
                            Servicio de carpintería profesional en Madrid: suelos de madera, puertas, armarios a medida, ventanas de aluminio y PVC. Instalación experta con medidas exactas y acabados premium.
                        </p>
